...
from src.dataset import download_data, get_transforms_from_config
...
def predict(cfg: dict, save_dir: str):
    ...
    for i in range(len(data)):
        ...
        band_data = download_data(area_of_interest, catalog, collections, datetime, band)
    ...
    data.to_file(os.path.join(save_dir, filename), driver='GeoJSON')
